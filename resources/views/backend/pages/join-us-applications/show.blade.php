...
<div class="modal-body">
    <div class="row">
        <div class="col-md-6 mb-3">
            <strong>Type:</strong>
            <p><span class="badge bg-{{ $application->type === 'model' ? 'primary' : 'info' }}">{{ ucfirst($application->type) }}</span></p>
        </div>
        <div class="col-md-6 mb-3">
        ...
        <div class="col-md-12 mb-3">
            ...
            <p>{{ $application->address }}{{ $application->apartment_suite_unit ? ', ' . $application->apartment_suite_unit : '' }}, {{ $application->city }}, {{ $application->postal_code }}</p>
        </div>
        @if($application->type === 'model')
            ...
            <div class="col-md-12 mb-3">
                ...
                <p>{{ is_array($application->comfort_preferences) ? implode(', ', $application->comfort_preferences) : $application->comfort_preferences }}</p>
            </div>
            @endif
            @if($application->model_experiences)
            <div class="col-md-12 mb-3">
                <strong>Model Experiences:</strong>
                <p>{{ is_array($application->model_experiences) ? implode(', ', $application->model_experiences) : $application->model_experiences }}</p>
            </div>
            @endif
        ...
        @else
            ...
            <div class="col-md-12 mb-3">
                ...
                <p>{{ is_array($application->areas_of_interest) ? implode(', ', $application->areas_of_interest) : $application->areas_of_interest }}</p>
            </div>
            @endif
            ...
            <div class="col-md-12 mb-3">
                ...
                <p>{{ is_array($application->availability) ? implode(', ', $application->availability) : $application->availability }}</p>
            </div>
            @endif
            @if($application->commitment_level)
            <div class="col-md-12 mb-3">
                <strong>Commitment Level:</strong>
                <p>{{ is_array($application->commitment_level) ? implode(', ', $application->commitment_level) : $application->commitment_level }}</p>
            </div>
            @endif
