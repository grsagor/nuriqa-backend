...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            ...
            <p>{{ $sponsorRequest->address }}{{ $sponsorRequest->apartment ? ', ' . $sponsorRequest->apartment : '' }}, {{ $sponsorRequest->city }}, {{ $sponsorRequest->postal_code }}</p>
        </div>
        <div class="col-md-12 mb-3">
        ...
        <div class="col-md-6 mb-3">
            ...
            <p>
                <span class="badge bg-{{ $sponsorRequest->status === 'approved' ? 'success' : ($sponsorRequest->status === 'rejected' ? 'danger' : 'warning') }}">
